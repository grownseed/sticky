(function (Raphael) {
    Raphael.colorwheel = function (x, y, size, initcolor, element, raphael) {
        return new ColorWheel(x, y, size, initcolor, element, raphael);
    };
    var pi = Math.PI,
        doc = document,
        win = window,
        ColorWheel = function (x, y, size, initcolor, element, raphael) {
            size = size || 200;
            var w3 = 3 * size / 200,
                w1 = size / 200,
                fi = 1.6180339887,
            ...
            var r = raphael || (element ? Raphael(element, size, size) : Raphael(x, y, size, size)),
            ...
            t.main_clone = t.main.clone().attr({
                stroke: "none",
                fill: "0-#fff-#fff",
                opacity: 0
            });
